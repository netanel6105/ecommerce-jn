...
const Dashboard = () => {
  ...
  return (
    ...
    //     <div className="absolute -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 flex flex-col items-center justify-center">
    //         <button className="bg-blue-600 rounded-full py-2 px-4" onClick={()=> setModalOpen(true)}>Logout</button>
    ...
    //           footer={
    //             <div className="flex gap-2 justify-end py-2">
    //               <button className="bg-green-600 rounded-full py-1 px-3 font-bold" onClick={()=>{
    //                 onExit()
    //               }}>
    //                 OK
    //               </button>
