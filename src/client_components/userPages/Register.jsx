...
<div className="flex justify-center">
    <div  className="overflow-hidden w-[900px] rounded-lg border border-gray-200 shadow-md m-5">
    <div className=' bg-neutral-800 pl-12  text-blue-300 p-4 font-medium'>Register</div>

    <form onSubmit={handleSubmit(onSubForm)} className="pl-[200px] px-8 pt-[100px] pb-8 mb-4 "> 
      ...
      <div className="mb-4">
        ...
        <input {...register("name", {  required: true, minLength: 2 })}
          className="shadow appearance-none border rounded w-96  py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" placeholder="Name" />
